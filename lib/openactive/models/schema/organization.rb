  ...
  module Models
    module Schema
      class Organization < ::OpenActive::Models::Schema::Thing
        ...
        define_property :has_member_program, as: "hasMemberProgram", types: [
        ...
        # @return [OpenActive::Models::Schema::ProgramMembership,OpenActive::Models::Schema::Organization,OpenActive::Models::Schema::MemberProgramTier,URI]
