  ...
  module Models
    module Schema
      class Grant < ::OpenActive::Models::Schema::Intangible
        ...
        # @return [OpenActive::Models::Schema::BioChemEntity,OpenActive::Models::Schema::MedicalEntity,OpenActive::Models::Schema::Person,OpenActive::Models::Schema::CreativeWork,OpenActive::Models::Schema::Organization,OpenActive::Models::Schema::Product,OpenActive::Models::Schema::Event,URI]
