  ...
  module Models
    module Schema
      class Demand < ::OpenActive::Models::Schema::Intangible
        ...
        # @return [OpenActive::Models::Schema::Product,OpenActive::Models::Schema::Trip,OpenActive::Models::Schema::Event,OpenActive::Models::Schema::MenuItem,OpenActive::Models::Schema::Service,OpenActive::Models::Schema::AggregateOffer,OpenActive::Models::Schema::CreativeWork,URI]
