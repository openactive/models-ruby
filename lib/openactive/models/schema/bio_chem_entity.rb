  ...
  module Models
    module Schema
      class BioChemEntity < ::OpenActive::Models::Schema::Thing
        ...
        # @return [OpenActive::Models::Schema::PropertyValue,OpenActive::Models::Schema::MedicalCondition,URI]
        ...
        # @return [OpenActive::Models::Schema::DefinedTerm,OpenActive::Models::Schema::PropertyValue,URI]
